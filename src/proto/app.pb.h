...
enum DataConfig_Format {
  DataConfig_Format_BIN = 1,
  DataConfig_Format_PROTO = 2
};
bool DataConfig_Format_IsValid(int value);
const DataConfig_Format DataConfig_Format_Format_MIN = DataConfig_Format_BIN;
const DataConfig_Format DataConfig_Format_Format_MAX = DataConfig_Format_PROTO;
const int DataConfig_Format_Format_ARRAYSIZE = DataConfig_Format_Format_MAX + 1;

const ::google::protobuf::EnumDescriptor* DataConfig_Format_descriptor();
inline const ::std::string& DataConfig_Format_Name(DataConfig_Format value) {
  return ::google::protobuf::internal::NameOfEnum(
    DataConfig_Format_descriptor(), value);
}
inline bool DataConfig_Format_Parse(
    const ::std::string& name, DataConfig_Format* value) {
  return ::google::protobuf::internal::ParseNamedEnum<DataConfig_Format>(
    DataConfig_Format_descriptor(), name, value);
}
// ===================================================================
...
class AppConfig : public ::google::protobuf::Message {
 public:
  ...
  // optional .AppConfig.Type type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::AppConfig_Type type() const;
  inline void set_type(::AppConfig_Type value);
...
class DataConfig : public ::google::protobuf::Message {
 public:
  ...
  typedef DataConfig_Format Format;
  static const Format BIN = DataConfig_Format_BIN;
  static const Format PROTO = DataConfig_Format_PROTO;
  static inline bool Format_IsValid(int value) {
    return DataConfig_Format_IsValid(value);
  }
  static const Format Format_MIN =
    DataConfig_Format_Format_MIN;
  static const Format Format_MAX =
    DataConfig_Format_Format_MAX;
  static const int Format_ARRAYSIZE =
    DataConfig_Format_Format_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Format_descriptor() {
    return DataConfig_Format_descriptor();
  }
  static inline const ::std::string& Format_Name(Format value) {
    return DataConfig_Format_Name(value);
  }
  static inline bool Format_Parse(const ::std::string& name,
      Format* value) {
    return DataConfig_Format_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // required .DataConfig.Format format = 1;
  inline bool has_format() const;
  inline void clear_format();
  static const int kFormatFieldNumber = 1;
  inline ::DataConfig_Format format() const;
  inline void set_format(::DataConfig_Format value);
...
inline ::AppConfig_Type AppConfig::type() const {
  return static_cast< ::AppConfig_Type >(type_);
}
inline void AppConfig::set_type(::AppConfig_Type value) {
  assert(::AppConfig_Type_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline ::DataConfig_Format DataConfig::format() const {
  return static_cast< ::DataConfig_Format >(format_);
}
inline void DataConfig::set_format(::DataConfig_Format value) {
  assert(::DataConfig_Format_IsValid(value));
  set_has_format();
  format_ = value;
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::AppConfig_Type>() {
  return ::AppConfig_Type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::DataConfig_Format>() {
  return ::DataConfig_Format_descriptor();
}

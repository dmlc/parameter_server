...
#ifndef PROTOBUF_proto_2fexample_2eproto__INCLUDED
#define PROTOBUF_proto_2fexample_2eproto__INCLUDED
...
void  protobuf_AddDesc_proto_2fexample_2eproto();
void protobuf_AssignDesc_proto_2fexample_2eproto();
void protobuf_ShutdownFile_proto_2fexample_2eproto();
...
class SlotInfo : public ::google::protobuf::Message {
 public:
  ...
  // optional .SlotInfo.Format format = 1;
  inline bool has_format() const;
  inline void clear_format();
  static const int kFormatFieldNumber = 1;
  inline ::SlotInfo_Format format() const;
  inline void set_format(::SlotInfo_Format value);
 ...
 private:
  ...
  friend void protobuf_ShutdownFile_proto_2fexample_2eproto();
...
class ExampleInfo : public ::google::protobuf::Message {
 public:
  ...
  inline const ::SlotInfo& slot(int index) const;
  inline ::SlotInfo* mutable_slot(int index);
  inline ::SlotInfo* add_slot();
  inline const ::google::protobuf::RepeatedPtrField< ::SlotInfo >&
      slot() const;
  inline ::google::protobuf::RepeatedPtrField< ::SlotInfo >*
      mutable_slot();
  ...
  // @@protoc_insertion_point(class_scope:ExampleInfo)
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::SlotInfo > slot_;
...
class Example : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_slot();
  static const int kSlotFieldNumber = 1;
  inline const ::Slot& slot(int index) const;
  inline ::Slot* mutable_slot(int index);
  inline ::Slot* add_slot();
  inline const ::google::protobuf::RepeatedPtrField< ::Slot >&
      slot() const;
  inline ::google::protobuf::RepeatedPtrField< ::Slot >*
      mutable_slot();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::Slot > slot_;
...
inline ::SlotInfo_Format SlotInfo::format() const {
  return static_cast< ::SlotInfo_Format >(format_);
}
inline void SlotInfo::set_format(::SlotInfo_Format value) {
  assert(::SlotInfo_Format_IsValid(value));
  set_has_format();
  format_ = value;
}
...
inline const ::SlotInfo& ExampleInfo::slot(int index) const {
  return slot_.Get(index);
}
inline ::SlotInfo* ExampleInfo::mutable_slot(int index) {
  return slot_.Mutable(index);
}
inline ::SlotInfo* ExampleInfo::add_slot() {
  return slot_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::SlotInfo >&
...
inline const ::Slot& Example::slot(int index) const {
  return slot_.Get(index);
}
inline ::Slot* Example::mutable_slot(int index) {
  return slot_.Mutable(index);
}
inline ::Slot* Example::add_slot() {
  return slot_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Slot >&
Example::slot() const {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::SlotInfo_Format>() {
  return ::SlotInfo_Format_descriptor();
}
...
#endif  // PROTOBUF_proto_2fexample_2eproto__INCLUDED
